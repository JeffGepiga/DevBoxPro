...
contextBridge.exposeInMainWorld('devbox', {
  ...
  projects: {
    ...
    update: (id, config, options) => ipcRenderer.invoke('projects:update', id, config, options),
  ...
  services: {
    ...
    getWebServerPorts: (webServerType, version) => ipcRenderer.invoke('services:getWebServerPorts', webServerType, version),
    getProjectLocalAccessPorts: (projectId) => ipcRenderer.invoke('services:getProjectLocalAccessPorts', projectId),
  ...
  binaries: {
    ...
    getRunningConflicts: (type, version) => ipcRenderer.invoke('binaries:getRunningConflicts', type, version),
    remove: (type, version, force) => ipcRenderer.invoke('binaries:remove', type, version, force),
