    ...
    beforeEach(() => {
        ...
        mockManagers = {
            ...
            binaryDownload: {
                ...
                checkForServiceUpdates: vi.fn(async () => ({ composer: { updateAvailable: false }, phpmyadmin: { updateAvailable: false }, cloudflared: { updateAvailable: false }, zrok: { updateAvailable: false } })),
